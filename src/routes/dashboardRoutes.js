...
async function routes(fastify) {
    ...
    fastify.put(
        '/users/:userId/dashboard/settings',
        userIdSchema,
    ...
    // Quick Stats
    fastify.get(
        '/users/:userId/dashboard/quick-stats',
        userIdSchema,
    ...
    fastify.put(
        '/users/:userId/dashboard/quick-stats',
        userIdSchema,
        dashboardController.updateQuickStats,
    );
    fastify.get(
        '/users/:userId/dashboard/quick-stats/data',
        userIdSchema,
        dashboardController.getQuickStatsData,
    );
    ...
    fastify.put(
        ...
        userIdSchema,
        dashboardController.updateWidgets,
    );

    // Alerts
    fastify.get('/users/:userId/dashboard/alerts', userIdSchema, dashboardController.getAlerts);
    fastify.get(
        '/users/:userId/dashboard/alerts/settings',
        userIdSchema,
        dashboardController.getAlertSettings,
    );
    fastify.put(
        '/users/:userId/dashboard/alerts/settings',
        userIdSchema,
