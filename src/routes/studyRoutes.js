...
async function studyRoutes(fastify, options) {
    ...
    // ==================== PERIODS ====================
    fastify.get(
        '/study/courses/:courseId/periods',
        {
            schema: {
    ...
    // ==================== SUBJECTS ====================
    fastify.get(
        '/study/periods/:periodId/subjects',
        {
            schema: {
    ...
    // ==================== SUBJECT WEIGHTS ====================
    fastify.get(
        '/study/subjects/:subjectId/weights',
        {
            schema: {
    ...
    // ==================== EVALUATIONS ====================
    fastify.get(
        '/study/subjects/:subjectId/evaluations',
        {
            schema: {
    ...
    fastify.get(
        '/users/:userId/study/evaluations/upcoming',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.post(
        '/users/:userId/study/evaluations',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    // ==================== EVALUATION FEEDBACK ====================
    fastify.get(
        '/study/evaluations/:evaluationId/feedback',
        {
            schema: {
    ...
    // ==================== ONLINE COURSES ====================
    fastify.get(
        '/users/:userId/study/courses-online',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.get(
        '/study/topics/:topicId/retention',
        {
            schema: {
    ...
    fastify.get(
        '/study/decks/:deckId/flashcards/due',
        {
            schema: {
    ...
    // ==================== REVIEW SESSIONS ====================
    fastify.get(
        '/users/:userId/study/review-sessions',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.put(
        '/study/review-sessions/:id/complete',
        {
            schema: {
    ...
    // ==================== PROJECT RESOURCES ====================
    fastify.post(
        '/study/projects/:projectId/resources',
        {
            schema: {
    ...
    // ==================== PROJECT MILESTONES ====================
    fastify.post(
        '/study/projects/:projectId/milestones',
        {
            schema: {
    ...
    // ==================== FOCUS SESSIONS ====================
    fastify.get(
        '/users/:userId/study/focus-sessions',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.get(
        '/users/:userId/study/focus-sessions/active',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.put(
        '/study/focus-sessions/:id/resume',
        {
            schema: {
    ...
    fastify.put(
        '/study/focus-sessions/:id/complete',
        {
            schema: {
    ...
    fastify.put(
        '/study/focus-sessions/:id/cancel',
        {
            schema: {
    ...
    // ==================== FOCUS BLOCKS ====================
    fastify.post(
        '/study/focus-sessions/:sessionId/blocks',
        {
            schema: {
