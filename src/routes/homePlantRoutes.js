...
async function homePlantRoutes(fastify, options) {
    // Plants CRUD
    fastify.get('/users/:userId/spaces/:spaceId/plants', homePlantController.getPlants);
    ...
    fastify.get('/users/:userId/spaces/:spaceId/plants/:plantId', homePlantController.getPlant);

    fastify.post('/users/:userId/spaces/:spaceId/plants', homePlantController.createPlant);

    fastify.put('/users/:userId/spaces/:spaceId/plants/:plantId', homePlantController.updatePlant);
