...
async function meetingRoutes(fastify, options) {
    ...
    // ==================== MEETING ACTIONS ====================
    fastify.get(
        '/work/meetings/:meetingId/actions',
        {
            schema: {
    ...
    fastify.post(
        '/work/meeting-actions/:id/convert-to-task',
        {
            schema: {
    ...
    // ==================== MEETING ANALYSIS ====================
    fastify.get(
        '/users/:userId/work/meetings/analysis',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
