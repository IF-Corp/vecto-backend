...
async function profileRoutes(fastify, options) {
    ...
    fastify.get(
        '/users/:userId/profile/xp/history',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.get(
        '/users/:userId/profile/achievements',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.get(
        '/users/:userId/profile/achievements/unlocked',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.get(
        '/users/:userId/profile/titles/unlocked',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.put(
        '/users/:userId/profile/titles/:titleId/active',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.delete(
        '/users/:userId/profile/titles/active',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
