...
async function habitRoutes(fastify, options) {
    ...
    fastify.post(
        '/routines/:id/items/:itemId/check',
        {
            schema: {
    ...
    fastify.put(
        '/routines/:id/executions/:executionId/pause',
        {
            schema: {
    ...
    fastify.put(
        '/routines/:id/executions/:executionId/resume',
        {
            schema: {
    ...
    fastify.put(
        '/routines/:id/executions/:executionId/complete',
        {
            schema: {
    ...
    fastify.put(
        '/routines/:id/executions/:executionId/cancel',
        {
            schema: {
