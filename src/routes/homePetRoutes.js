...
async function homePetRoutes(fastify, options) {
    // Pets CRUD
    fastify.get('/users/:userId/spaces/:spaceId/pets', homePetController.getPets);
    ...
    fastify.get('/users/:userId/spaces/:spaceId/pets/:petId', homePetController.getPet);
    ...
    fastify.post('/users/:userId/spaces/:spaceId/pets', homePetController.createPet);

    fastify.put('/users/:userId/spaces/:spaceId/pets/:petId', homePetController.updatePet);

    fastify.delete('/users/:userId/spaces/:spaceId/pets/:petId', homePetController.deletePet);
