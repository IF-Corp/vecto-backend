...
async function freezeModeRoutes(fastify, options) {
    ...
    fastify.get(
        '/users/:userId/freeze-periods/active',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.get(
        '/users/:userId/freeze-periods/statistics',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.post(
        '/users/:userId/freeze-mode/activate',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.post(
        '/users/:userId/freeze-mode/deactivate',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.post(
        '/freeze-periods/process-scheduled',
        {
            schema: {
                description:
                    'Process scheduled freeze periods (activate due periods, complete expired ones)',
                tags: ['Freeze Mode'],
                response: {
                    200: {
                        type: 'object',
