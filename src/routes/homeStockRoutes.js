...
async function homeStockRoutes(fastify, options) {
    ...
    fastify.get('/users/:userId/spaces/:spaceId/stock', homeStockController.getStockItems);

    // Get low stock items
    fastify.get('/users/:userId/spaces/:spaceId/stock/low', homeStockController.getLowStockItems);
    ...
    fastify.get('/users/:userId/spaces/:spaceId/stock/:itemId', homeStockController.getStockItem);

    // Create a new stock item
    fastify.post('/users/:userId/spaces/:spaceId/stock', homeStockController.createStockItem);
