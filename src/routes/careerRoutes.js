...
async function careerRoutes(fastify, options) {
    ...
    // ==================== CERTIFICATIONS ====================
    fastify.get(
        '/users/:userId/work/certifications',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    // ==================== ACHIEVEMENTS ====================
    fastify.get(
        '/users/:userId/work/achievements',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    // ==================== CAREER TIMELINE ====================
    fastify.get(
        '/users/:userId/work/career/timeline',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
