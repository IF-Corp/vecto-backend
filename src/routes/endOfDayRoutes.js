...
async function endOfDayRoutes(fastify, options) {
    ...
    fastify.get(
        '/users/:userId/end-of-day/tasks-completion',
        endOfDayController.getTodayTasksCompletion,
    );
    fastify.get('/users/:userId/end-of-day/hours-worked', endOfDayController.getTodayWorkedHours);

    // Move uncompleted tasks
    fastify.post(
        '/users/:userId/end-of-day/move-tasks',
        endOfDayController.moveUncompletedTasksToTomorrow,
    );
    ...
    fastify.get(
        '/users/:userId/end-of-day/productivity-trends',
        endOfDayController.getProductivityTrends,
    );
}
