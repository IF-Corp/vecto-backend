...
async function billingRoutes(fastify, options) {
    ...
    // ==================== BILLING SUMMARY ====================
    fastify.get(
        '/users/:userId/work/billing/summary',
        {
    ...
    // ==================== TIMESHEET REPORT ====================
    fastify.get(
        '/users/:userId/work/billing/timesheet-report',
        {
            preHandler: [fastify.authorizeUser],
            schema: {
    ...
    fastify.post(
        '/work/invoices/:id/mark-invoiced',
        {
            schema: {
